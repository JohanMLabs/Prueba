<%-- 
    ...
    Created on : 12/07/2019, 12:04:04 PM
    Author     : blanclabs
--%>
...
<h1 class="text-center">Listar Usuarios</h1><br>
...
<form action="Usuario" method="POST">
    <table id="datatable-keytable" class="table table-striped table-bordered" style="width: 100%;">
        <thead>
            <tr>
                <td style="border: 3px;border-bottom-color: #007bff;" class="text-center">IdUsuario</td>
                <td style="border: 3px;border-bottom-color: #007bff;" class="text-center">Nombre</td>
                <td style="border: 3px;border-bottom-color: #007bff;" class="text-center">RolFK</td>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center"><%= rs.getString("RolFK")%></td>
                <td class="text-center"><%= rs.getString("DepartamentoFK")%></td>
              
                <td class="text-center">
                    <a class="btn btn-warning btnEditarHard" data-id="<%=rs.getString("IdUsuario")%>"><i class="fa fa-pencil"></i> Editar</a>
                    <a class="btn btn-danger btnEliminarHard" data-id="<%=rs.getString("IdUsuario")%>"><i class="fa fa-trash-o"></i> Eliminar</a>
